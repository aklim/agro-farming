            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="footer__item">
                        ...
                        <p class="footer__copy">© 2019, Agricom. All rights reserved.<br/>Template by <a
                                href="https://themeforest.net/user/artureanec" target="_blank">Artureanec</a></p>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="footer__item">
                        ...
                        <form class="footer__form form-horizontal" action="#">
                            <p>Effervescent the secure special. Kids spicey chance excellent proven too sleek
                                handcrafted when makes intense</p>
