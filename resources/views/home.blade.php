...
@section('content')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-8 col-xl-9">
                    <div class="col-MB-30">
                        <h4>
                            Smells racy free announcing than durable zesty smart exotic far feel. Screamin' affordable
                            secret way absolutely.
                        </h4>
    ...
    <!-- start section -->
    <section class="section section--no-pt section--custom-1">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="col-MB-30">
                        <img class="img-fluid" src="../images/slogan.png" alt="demo"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section section--custom-2">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p>
                        ...
                        handcrafted bigger comes newer recommended lifetime.
                    </p>
                    ...
                    <p class="d-lg-none"><img class="img-fluid" src="../images/img_7.jpg" alt="demo"/></p>
        ...
        <div class="img-place" style="background-image: url('../images/img_7.jpg');"></div>
    </section>
    <!-- end section -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="timeline__item">
                                ...
                                <p>
                                    Odor to yummy high racy bonus soaking mouthwatering. First superior full-bodied
                                    drink.
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="gallery__item__inner">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/gall_img/4_col/2.jpg');"
                                             alt="demo"/>

                                        <a class="gallery__item__description"
                                           href="http://player.vimeo.com/video/95974049" data-gallery="gall">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="gallery__item">
                                <div class="gallery__item__inner">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/gall_img/4_col/3.jpg');"
                                             alt="demo"/>

                                        <a class="gallery__item__description" href="../images/gall_img/4_col/3.jpg"
                                           data-gallery="gall">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="gallery__item">
                                <div class="gallery__item__inner">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/gall_img/4_col/4.jpg');"
                                             alt="demo"/>

                                        <a class="gallery__item__description" href="../images/gall_img/4_col/4.jpg"
                                           data-gallery="gall">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="gallery__item">
                                <div class="gallery__item__inner">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/gall_img/4_col/5.jpg');"
                                             alt="demo"/>

                                        <a class="gallery__item__description" href="../images/gall_img/4_col/5.jpg"
                                           data-gallery="gall">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="gallery__item">
                                <div class="gallery__item__inner">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/gall_img/4_col/6.jpg');"
                                             alt="demo"/>

                                        <a class="gallery__item__description" href="../images/gall_img/4_col/6.jpg#"
                                           data-gallery="gall">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="gallery__item">
                                <div class="gallery__item__inner">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/gall_img/4_col/7.jpg');"
                                             alt="demo"/>

                                        <a class="gallery__item__description" href="../images/gall_img/4_col/7.jpg"
                                           data-gallery="gall">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="gallery__item">
                                <div class="gallery__item__inner">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/gall_img/4_col/8.jpg');"
                                             alt="demo"/>

                                        <a class="gallery__item__description" href="../images/gall_img/4_col/8.jpg"
                                           data-gallery="gall">
                            ...
                            <div class="row align-items-md-center">
                                <div class="col-md-6 col-lg-8 col-xl-6">
                                    <div class="blog__entry">
                                        ...
                                        <h3 class="blog__entry__title"><a href="blog_post.html">Agriculture Products</a>
                                        </h3>

                                        <span class="blog__entry__meta">Cows | 4 Comments</span>

                                        <p>
                                            Appetizing luscious savor hot senses. Effervescent the secure special. Kids
                                            spicey chance excellent proven too
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-6">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/blog_img/1.jpg');" alt="demo">
                                    </figure>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-md-center">
                                <div class="col-md-6 col-lg-8 col-xl-6">
                                    <div class="blog__entry">
                                        ...
                                        <h3 class="blog__entry__title"><a href="blog_post.html">Crispy citrus
                                                exclusive</a></h3>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-6">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/blog_img/4.jpg');" alt="demo">
                                    </figure>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-md-center">
                                <div class="col-md-6 col-lg-8 col-xl-6">
                                    <div class="blog__entry">
                                        ...
                                        <h3 class="blog__entry__title"><a href="blog_post.html">Waxy latest also
                                                drink</a></h3>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-6">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/blog_img/3.jpg');" alt="demo">
                                    </figure>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="blog__item">
                            <div class="row align-items-md-center">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-6">
                                    <figure>
                                        <img src="../images/blank.gif"
                                             style="background-image: url('../images/blog_img/2.jpg');" alt="demo">
                                    </figure>
                                </div>
                            </div>
                        </div>
    ...
    <!-- start section -->
    <section class="section jarallax" data-speed="0.4" data-img-position="50% 50%"
             style="background-image: url('../images/bg/bg_9.jpg');">
        <div class="container">
                            ...
                            <article class="feedback__item">
                                <div class="feedback__author">
                                    <div class="feedback__author__photo  mx-auto">
                                        <img class="circled  img-fluid" src="../images/users_photos/4.png" height="140"
                                             width="140" alt="demo"/>
                                    </div>
                                ...
                                <div class="feedback__text">
                                    <p>
                                        “Absorbent lower warranty smart deluxe lasting sporty fast customer spring
                                        rated. Free every challenge your spicey racy. Introducing handcrafted
                                        credit-card like supreme monster just hurry fresh outlasts flip quality.
                                    </p>
                                </div>
                            </article>
                            <!-- end item -->
                            ...
                            <article class="feedback__item">
                                ...
                                <div class="feedback__text">
                                    <p>
                                        “Absorbent lower warranty smart deluxe lasting sporty fast customer spring
                                        rated. Free every challenge your spicey racy. Introducing handcrafted
                                        credit-card like supreme monster just hurry fresh outlasts flip quality. Value
                                        far mouthwatering wherever try offer ultra aroma
                                    </p>
                                </div>
                            </article>
                            <!-- end item -->
                            ...
                            <article class="feedback__item">
                                ...
                                <div class="feedback__text">
                                    <p>
                                        ...
                                        rated. Free every challenge your spicey racy. Introducing handcrafted
                                        credit-card like supreme monster just hurry fresh outlasts flip quality. Value
                                        far mouthwatering wherever try offer ultra aroma Introducing handcrafted
                                        credit-card like supreme monster
                                    </p>
                                </div>
                            </article>
                            <!-- end item -->
                ...
                <div class="partners__inner">
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <img class="img-fluid" src="../images/partners_img/1.jpg" alt="demo"/>
                        </div>
                        <!-- end item -->

                        <!-- start item -->
                        <div class="col-6 col-sm-4 col-lg-2">
                            <img class="img-fluid" src="../images/partners_img/2.jpg" alt="demo"/>
                        </div>
                        <!-- end item -->

                        <!-- start item -->
                        <div class="col-6 col-sm-4 col-lg-2">
                            <img class="img-fluid" src="../images/partners_img/3.jpg" alt="demo"/>
                        </div>
                        <!-- end item -->

                        <!-- start item -->
                        <div class="col-6 col-sm-4 col-lg-2">
                            <img class="img-fluid" src="../images/partners_img/4.jpg" alt="demo"/>
                        </div>
                        <!-- end item -->

                        <!-- start item -->
                        <div class="col-6 col-sm-4 col-lg-2">
                            <img class="img-fluid" src="../images/partners_img/5.jpg" alt="demo"/>
                        </div>
                        <!-- end item -->

                        <!-- start item -->
                        <div class="col-6 col-sm-4 col-lg-2">
                            <img class="img-fluid" src="../images/partners_img/6.jpg" alt="demo"/>
                        </div>
                        <!-- end item -->
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 bg-1">
                    <div class="item">
                        <header class="item__header">
                            ...
                            <p class="item__subtitle">Mega bold action. Sold care wherever less appetizing your far
                                easily</p>
                        </header>
                ...
                <div class="col-12 col-md-6 bg-2">
                    <div class="item">
                        <header class="item__header">
                            ...
                            <p class="item__subtitle">Vinyl grown remarkable in survey wherever parents are it's. Mega
                                bold action. Sold care</p>
                        </header>
                ...
                <div class="col-12">
                    <div class="item map-container">
                        <div class="g_map"
                             data-api-key="AIzaSyBUFnWlRpat3ReOI_Fm7n76LhxZCI5kja4"
